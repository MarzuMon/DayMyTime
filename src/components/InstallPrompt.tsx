...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-card border-t shadow-elevated animate-fade-in">
      <div className="max-w-md mx-auto flex items-center gap-3">
        <Download className="h-8 w-8 text-primary flex-shrink-0" />
        <div className="flex-1">
          <p className="font-semibold text-sm">Install Day My Time</p>
