  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="max-w-3xl mx-auto px-4 py-16 prose prose-sm dark:prose-invert">
        ...
        <p>By accessing or using Day My Time ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, please do not use the Service.</p>

        <h2>2. Description of Service</h2>
        <p>Day My Time is a visual scheduling application that helps users manage their daily tasks, meetings, and notifications. The Service is available as a free tier and a paid Pro subscription.</p>
        ...
        <p>All content, design, and code of Day My Time are the property of Day My Time and are protected by intellectual property laws. You retain ownership of the data you create within the Service.</p>

        <h2>7. Limitation of Liability</h2>
        <p>Day My Time is provided "as is" without warranties of any kind. We shall not be liable for any indirect, incidental, or consequential damages arising from your use of the Service.</p>
